...
var colors=[
  ...
  // Your new light blue scheme (index 7)
...
var colId = 7, backId = 8; // Set default colId to 7 for Light Blue
var ci = localStorage.getItem("colId");

if (ci != null) {
  colId = parseInt(ci);
}
var bi = localStorage.getItem("backId"); // Moved to a new line for clarity
if (bi != null) {
  backId = parseInt(bi);
}
