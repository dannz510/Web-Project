function Console(parent){
  ...
  var dir=parent.gec0("dir"), dirUrl="Z:\\Dannz.github.io";
  ...
  var help={
    commands: [
      ...
      ["Command","Description"],
      ["-----------","---------------"],
      ["cd","change directory to root (Z:)"],
      ["cd <file/folder>","goto file/folder from current position"],
      ["cd <path>","Z:/ url -> change directory to specified path"],
  ...
  addLine(null,true);
  setTimeout(function(){
    print(compileCowsay(cowsay("Dannz DzOS [Version 2.0]\nCmd-DZ v1.0.\n(C) 2025 Dannz\n----------------------------------\nType 'help' for help with commands.","duck")));
  },500);
  loadDir(dirUrl,true);
}
